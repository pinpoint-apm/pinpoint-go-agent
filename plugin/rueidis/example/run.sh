...
echo "================================================"
echo "Redis (Rueidis) + Go Example Runner"
echo "================================================"
...
# Container name
CONTAINER_NAME="redis-rueidis-test"
APP_PORT="9014"
...
docker build -t redis-rueidis-test .
...
echo "Building rueidis_example..."
go build -o rueidis_example rueidis_example.go
...
echo ""
echo "Test endpoint:"
echo "  curl http://localhost:$APP_PORT/rueidis"
echo ""
