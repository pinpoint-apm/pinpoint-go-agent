...
echo "================================================"
echo "Cassandra (gocql/v2) + Go Example Runner"
echo "================================================"
...
# Container name
CONTAINER_NAME="cassandra-gocqlv2-test"
APP_PORT="9025"
...
docker build -t cassandra-gocqlv2-test .
...
docker exec $CONTAINER_NAME cqlsh -k example -e "INSERT INTO tweet (timeline, id, text) VALUES ('me', uuid(), 'Testing Cassandra with gocql/v2');" > /dev/null 2>&1
...
echo "Building gocqlv2_example..."
go build -o gocqlv2_example gocqlv2_example.go
