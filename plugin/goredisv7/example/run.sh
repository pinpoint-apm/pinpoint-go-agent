...
echo "================================================"
echo "Redis (go-redis v7) + Go Example Runner"
echo "================================================"
...
# Container names
CONTAINER_NAME_1="redis-goredisv7-test-1"
CONTAINER_NAME_2="redis-goredisv7-test-2"
APP_PORT="9010"
...
docker build -t redis-goredisv7-test .
...
enable: true
applicationName: GoRedisv7Test
agentName: GoRedisv7TestAgent
collector:
  host: localhost
  agentPort: 9991
  statPort: 9992
...
echo "Building redisv7..."
go build -o redisv7 redisv7.go
