...
echo "================================================"
echo "Elasticsearch (goelasticv8) + Go Example Runner"
echo "================================================"
...
# Container name
CONTAINER_NAME="elasticsearch-goelasticv8-test"
APP_PORT="9025"
...
echo -e "\n${YELLOW}[1/6] Checking for existing Elasticsearch container...${NC}"
...
echo "Started Elasticsearch server on port 9200"

# Step 4: Wait for Elasticsearch to be ready
echo -e "\n${YELLOW}[4/6] Waiting for Elasticsearch to be ready...${NC}"
echo "This may take 30-60 seconds (Elasticsearch takes time to initialize)..."
...
# Additional wait to ensure Elasticsearch is fully ready
sleep 2
...
enable: true
applicationName: GoElasticv8Test
agentName: GoElasticv8TestAgent
collector:
  host: localhost
  agentPort: 9991
  statPort: 9992
...
echo "Building goelasticv8..."
go build -o goelasticv8 goelasticv8.go
...
echo ""
echo "Test endpoint:"
echo "  curl http://localhost:$APP_PORT/elastic"
echo ""
