...
echo "================================================"
echo "Elasticsearch (goelasticv9) + Go Example Runner"
echo "================================================"
...
# Container name
CONTAINER_NAME="elasticsearch-goelasticv9-test"
APP_PORT="9026"
...
enable: true
applicationName: GoElasticv9Test
agentName: GoElasticv9TestAgent
collector:
  host: localhost
  agentPort: 9991
  statPort: 9992
...
echo "Building goelasticv9..."
go build -o goelasticv9 goelasticv9.go
