...
docker build -t redis-goredis-test .
...
enable: true
applicationName: GoRedisTest
agentName: GoRedisTestAgent
collector:
  host: localhost
  agentPort: 9991
  statPort: 9992
...
echo "Building redisv6..."
go build -o redisv6 redisv6.go
