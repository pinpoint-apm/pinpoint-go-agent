...
echo "================================================"
echo "PostgreSQL (pgxv5) + Go Example Runner"
echo "================================================"
...
docker build -t postgres-pgxv5-test .
...
echo "Building pgxv5_example..."
go build -o pgxv5_example pgxv5_example.go
...
echo ""
echo "Test endpoints:"
echo "  curl http://localhost:$APP_PORT/tableCount"
echo "  curl http://localhost:$APP_PORT/query"
echo "  curl http://localhost:$APP_PORT/batch"
echo "  curl http://localhost:$APP_PORT/query_std"
echo ""
