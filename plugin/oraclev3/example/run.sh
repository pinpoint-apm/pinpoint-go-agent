...
echo "================================================"
echo "Oracle Database XE + Go (go-ora v3) Example Runner"
echo "================================================"
...
enable: true
applicationName: GoOracleV3Test
agentName: GoOracleV3TestAgent
collector:
  host: localhost
  agentPort: 9991
  statPort: 9992
...
echo "Building oraclev3_example..."
go build -o oraclev3_example oraclev3_example.go
